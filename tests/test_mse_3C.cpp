...
//==================================================================================================
//
using mse_f_df_cm = matrix_storage_engine<float, extents<dynamic_extent, 1>, std::allocator<float>, column_major>;
using mse_f_df_rm = matrix_storage_engine<float, extents<dynamic_extent, 1>, std::allocator<float>, row_major>;
using mse_i_df_cm = matrix_storage_engine<int, extents<dynamic_extent, 1>, std::allocator<int>, column_major>;
using mse_d_df_rm = matrix_storage_engine<double, extents<dynamic_extent, 1>, std::allocator<double>, row_major>;
