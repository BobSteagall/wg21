...
//==================================================================================================
//
using mse_f_fd_cm = matrix_storage_engine<float, 1, std::dynamic_extent, std::allocator<float>, matrix_layout::column_major>;
using mse_f_fd_rm = matrix_storage_engine<float, 1, std::dynamic_extent, std::allocator<float>, matrix_layout::row_major>;
using mse_i_fd_cm = matrix_storage_engine<int, 1,   std::dynamic_extent, std::allocator<int>, matrix_layout::column_major>;
using mse_d_fd_rm = matrix_storage_engine<double, 1, std::dynamic_extent, std::allocator<double>, matrix_layout::column_major>;
