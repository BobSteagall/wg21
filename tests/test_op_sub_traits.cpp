...
{
    using subtraction_element_traits = test_element_sub_traits_ord;
    using subtraction_engine_traits  = test_engine_sub_traits_ord;
    using subtraction_arithmetic_traits         = test_sub_traits_ord;
};
...
struct test_sub_op_traits_nta
{
    ...
    template<class OT, class OP1, class OP2>
    using subtraction_arithmetic_traits = test_sub_traits_nta<OT, OP1, OP2>;
};
...
void t203()
{
    ...
    using t00 = STD_LA::detail::element_sub_result_t<test_sub_op_traits_tst, float, float>;
    PRINT_TYPE(t00);

    using t01 = STD_LA::detail::element_sub_result_t<test_sub_op_traits_tst, float, double>;
    PRINT_TYPE(t01);
}
...
void t204()
{
    ...
    using t00 = STD_LA::detail::engine_sub_result_t<test_sub_op_traits_tst,
                                                    fs_matrix_engine_tst<float, 3, 4>,
                                                    fs_matrix_engine_tst<float, 3, 4>>;
    PRINT_TYPE(t00);

    using t01 = STD_LA::detail::engine_sub_result_t<test_sub_op_traits_tst,
                                                    STD_LA::fs_matrix_engine<float, 3, 4>,
                                                    fs_matrix_engine_tst<float, 3, 4>>;
    PRINT_TYPE(t01);

    ASSERT_A_SUB_B_EQ_C(fsm_float,      fsm_float,      fsm_float);
    ASSERT_A_SUB_B_EQ_C(fsm_float,      fsm_float_tst,  fsm_double_tst);
