...
//==================================================================================================
//  Unit tests for fixed-size statically allocated matrix engine, Case 2A
//==================================================================================================
//
...
TEST(MSE_Matrix_2A, DefaultCtor)
{
    ...
    EXPECT_EQ(e1.size(), itup_t(1, 4));
    EXPECT_EQ(e1.row_capacity(), 1);
    EXPECT_EQ(e1.column_capacity(), 4);
    EXPECT_EQ(e1.capacity(), itup_t(1, 4));
...
TEST(MSE_Matrix_2A, CmpEq)
{
    ...
    EXPECT_FALSE(m_cmp_eq(e3, mse_f_ffv_rm(LST_14_1)));
}
