...
//==================================================================================================
//
using mse_f_ffv_cm = matrix_storage_engine<float, 4, 4, void, matrix_layout::column_major>;
using mse_f_ffv_rm = matrix_storage_engine<float, 4, 4, void, matrix_layout::row_major>;
using mse_i_ffv_cm = matrix_storage_engine<int, 4, 4, void, matrix_layout::column_major>;
using mse_d_ffv_rm = matrix_storage_engine<double, 4, 4, void, matrix_layout::row_major>;
