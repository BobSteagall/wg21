...
//==================================================================================================
//
using mse_f_ffv_cm = matrix_storage_engine<float, extents<size_t, 4, 4>, void, matrix_layout::column_major>;
using mse_f_ffv_rm = matrix_storage_engine<float, extents<size_t, 4, 4>, void, matrix_layout::row_major>;
using mse_i_ffv_cm = matrix_storage_engine<int,   extents<size_t, 4, 4>, void, matrix_layout::column_major>;
using mse_d_ffv_rm = matrix_storage_engine<double, extents<size_t, 4, 4>, void, matrix_layout::row_major>;
...
TEST(MSE_Matrix_4A, CmpEq)
{
    ...
    EXPECT_FALSE(msupport::compare(e3, mse_f_ffv_rm(LST_44_1)));
}
