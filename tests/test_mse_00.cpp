...
TEST(MSE_Vector, CmpEq)
{
    ...
    EXPECT_TRUE(v_cmp_eq(e2, e2));
    EXPECT_TRUE(v_cmp_eq(e2, e3));
    EXPECT_TRUE(v_cmp_eq(e3, e3));
    ...
    EXPECT_TRUE(v_cmp_eq(e3, {0, 0, 0, 0}));
    ...
    EXPECT_FALSE(v_cmp_eq(e2, l2));
    EXPECT_FALSE(v_cmp_eq(e2, {13, 17, 19, 23}));
    EXPECT_FALSE(v_cmp_eq(e3, l2));
    EXPECT_FALSE(v_cmp_eq(e3, {13, 17, 19, 23}));
    ...
    EXPECT_FALSE(v_cmp_eq(e3, fve_type_v({11, 17, 19, 23})));

    EXPECT_FALSE(v_cmp_eq(e3, {13, 11, 19, 23}));
    EXPECT_FALSE(v_cmp_eq(e3, fve_type_a({13, 11, 19, 23})));

    EXPECT_FALSE(v_cmp_eq(e3, {13, 17, 11, 23}));
    EXPECT_FALSE(v_cmp_eq(e3, dve_type({13, 17, 11, 23})));

    EXPECT_FALSE(v_cmp_eq(e3, {13, 17, 19, 11}));
    EXPECT_FALSE(v_cmp_eq(e3, dve_type({13, 17, 19, 11})));
}
...
TEST(MSE_Vector, MoveCtor)
{
    ...
    EXPECT_TRUE(v_cmp_eq(e1b, l1));
    EXPECT_TRUE(v_cmp_eq(e2b, l1));
    EXPECT_TRUE(v_cmp_eq(e3b, l1));
}
...
TEST(MSE_Vector, EngineCtor)
{
    ...
    EXPECT_TRUE(v_cmp_eq(e1, il_4_1));
    EXPECT_TRUE(v_cmp_eq(e2, il_4_2));
    EXPECT_TRUE(v_cmp_eq(e3, il_4_3));
    ...
    EXPECT_TRUE(v_cmp_eq(e1b, il_4_2));
    EXPECT_TRUE(v_cmp_eq(e1b, e2));
    EXPECT_FALSE(v_cmp_eq(e1b, e1));

    EXPECT_TRUE(v_cmp_eq(e2b, il_4_3));
    EXPECT_TRUE(v_cmp_eq(e2b, e3));
    EXPECT_FALSE(v_cmp_eq(e2b, e2));

    EXPECT_TRUE(v_cmp_eq(e3b, il_4_1));
    EXPECT_TRUE(v_cmp_eq(e3b, e1));
    EXPECT_FALSE(v_cmp_eq(e3b, e3));
}
...
TEST(MSE_Vector, ListAssign)
{
    ...
    EXPECT_TRUE(v_cmp_eq(e1a, fl_4_0));
    EXPECT_TRUE(v_cmp_eq(e1b, fl_4_1));

    EXPECT_TRUE(v_cmp_eq(e2a, fl_4_0));
    EXPECT_TRUE(v_cmp_eq(e2b, fl_4_2));
    ...
    e1a = l0;
    e1b = l0;
    EXPECT_TRUE(v_cmp_eq(e1a, l0));
    EXPECT_TRUE(v_cmp_eq(e1b, l0));
    EXPECT_TRUE(v_cmp_eq(e1a, e1b));

    e2a = l0;
    e2b = l0;
    EXPECT_TRUE(v_cmp_eq(e2a, l0));
    EXPECT_TRUE(v_cmp_eq(e2b, l0));
    EXPECT_TRUE(v_cmp_eq(e2a, e2b));

    e3a = l0;
    e3b = l0;
    EXPECT_TRUE(v_cmp_eq(e3a, l0));
    EXPECT_TRUE(v_cmp_eq(e3b, l0));
    EXPECT_TRUE(v_cmp_eq(e3a, e3b));
}
...
TEST(MSE_Vector, MoveAssign)
{
    ...
    EXPECT_TRUE(v_cmp_eq(e1a, fl_4_0));
    EXPECT_TRUE(v_cmp_eq(e1b, fl_4_1));
    EXPECT_TRUE(v_cmp_eq(e1c, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e1d, fl_4_3));

    EXPECT_TRUE(v_cmp_eq(e2a, fl_4_0));
    EXPECT_TRUE(v_cmp_eq(e2b, fl_4_1));
    EXPECT_TRUE(v_cmp_eq(e2c, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e2d, fl_4_3));

    EXPECT_EQ(e3a.size(), 0);
    EXPECT_TRUE(v_cmp_eq(e3b, fl_4_1));
    ...
    e1a = std::move(e1c);
    e1b = std::move(e1d);
    EXPECT_TRUE(v_cmp_eq(e1a, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e1b, fl_4_3));

    e2a = std::move(e2c);
    e2b = std::move(e2d);
    EXPECT_TRUE(v_cmp_eq(e2a, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e2b, fl_4_3));

    e3a = std::move(e3c);
    e3b = std::move(e3d);
    EXPECT_TRUE(v_cmp_eq(e3a, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e3b, fl_4_3));
}
...
TEST(MSE_Vector, CopyAssign)
{
    ...
    EXPECT_TRUE(v_cmp_eq(e1a, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e1b, fl_4_3));
    EXPECT_TRUE(v_cmp_eq(e1a, e1c));
    EXPECT_TRUE(v_cmp_eq(e1b, e1d));

    e2a = e2c;
    e2b = e2d;
    EXPECT_TRUE(v_cmp_eq(e2a, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e2b, fl_4_3));
    EXPECT_TRUE(v_cmp_eq(e2a, e2c));
    EXPECT_TRUE(v_cmp_eq(e2b, e2d));

    e3a = e3c;
    e3b = e3d;
    EXPECT_TRUE(v_cmp_eq(e3a, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e3b, fl_4_3));
    EXPECT_TRUE(v_cmp_eq(e3a, e3c));
    EXPECT_TRUE(v_cmp_eq(e3b, e3d));
}
...
TEST(MSE_Vector, EngineAssign)
{
    ...
    EXPECT_TRUE(v_cmp_eq(e1a, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e1b, fl_4_3));
    EXPECT_TRUE(v_cmp_eq(e1a, e2c));
    EXPECT_TRUE(v_cmp_eq(e1b, e2d));

    e2a = e3c;
    e2b = e3d;
    EXPECT_TRUE(v_cmp_eq(e2a, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e2b, fl_4_3));
    EXPECT_TRUE(v_cmp_eq(e2a, e3c));
    EXPECT_TRUE(v_cmp_eq(e2b, e3d));

    e3a = e1c;
    e3b = e1d;
    EXPECT_TRUE(v_cmp_eq(e3a, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e3b, fl_4_3));
    EXPECT_TRUE(v_cmp_eq(e3a, e1c));
    EXPECT_TRUE(v_cmp_eq(e3b, e1d));
}
...
TEST(MSE_Vector, Swap)
{
    ...
    EXPECT_TRUE(v_cmp_eq(e1a, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e1b, fl_4_3));
    EXPECT_TRUE(v_cmp_eq(e1c, fl_4_0));
    EXPECT_TRUE(v_cmp_eq(e1d, fl_4_1));

    e2a.swap(e2c);
    e2b.swap(e2d);
    EXPECT_TRUE(v_cmp_eq(e2a, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e2b, fl_4_3));
    EXPECT_TRUE(v_cmp_eq(e2c, fl_4_0));
    EXPECT_TRUE(v_cmp_eq(e2d, fl_4_1));
    ...
    EXPECT_TRUE(v_cmp_eq(e3d, fl_4_1));
}
...
TEST(MSE_Vector, Span)
{
    ...
    EXPECT_TRUE(v_cmp_eq(e1, fl_4_1));
    EXPECT_TRUE(v_cmp_eq(e2, fl_4_2));
    EXPECT_TRUE(v_cmp_eq(e3, fl_4_3));
    ...
    EXPECT_TRUE(v_cmp_eq(e2, sp2));
    EXPECT_TRUE(v_cmp_eq(e2, csp2));
    EXPECT_TRUE(v_cmp_eq(e3, sp3));
    EXPECT_TRUE(v_cmp_eq(e3, csp3));

    EXPECT_FALSE(v_cmp_eq(e1, sp3));
    EXPECT_FALSE(v_cmp_eq(e1, csp3));
    EXPECT_FALSE(v_cmp_eq(e2, sp1));
    EXPECT_FALSE(v_cmp_eq(e2, csp1));
    EXPECT_FALSE(v_cmp_eq(e3, sp2));
    EXPECT_FALSE(v_cmp_eq(e3, csp2));
    ...
    sp2(2) = 13.0f;
    sp2(3) = 14.0f;
    EXPECT_TRUE(v_cmp_eq(e2, {11, 12, 13, 14}));
