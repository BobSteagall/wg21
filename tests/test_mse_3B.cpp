...
//==================================================================================================
//
using mse_f_ffa_cm = matrix_storage_engine<float, extents<size_t, 4, 1>, std::allocator<float>, matrix_layout::column_major>;
using mse_f_ffa_rm = matrix_storage_engine<float, extents<size_t, 4, 1>, std::allocator<float>, matrix_layout::row_major>;
using mse_i_ffa_cm = matrix_storage_engine<int,   extents<size_t, 4, 1>, std::allocator<int>, matrix_layout::column_major>;
using mse_d_ffa_rm = matrix_storage_engine<double, extents<size_t, 4, 1>, std::allocator<double>, matrix_layout::row_major>;
...
TEST(MSE_Matrix_3B, ListCtor)
{
    //- Construct new engines via list ctor and verify that their initial states.
    //
    mse_f_ffa_rm    e1 = LST_41_1;
    mse_f_ffa_rm    e2 LST_41_1 ;
    mse_f_ffa_rm    e3(LST_41_1);
...
TEST(MSE_Matrix_3B, EngineAssign)
{
    //- Default construct and verify initial state.
    //
    mse_f_ffa_rm    e1, e2;
...
TEST(MSE_Matrix_3B, OtherAssign)
{
    //- Default construct and verify initial state.
    //
    mse_f_ffa_rm     e1;
...
TEST(MSE_Matrix_3B, Span)
{
    mse_f_ffa_rm        e1(il_41_2), e2, e3{e1};
