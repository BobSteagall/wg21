...
//==================================================================================================
//
using mse_f_ffa_cm = matrix_storage_engine<float, extents<size_t, 4, 4>, std::allocator<float>, matrix_layout::column_major>;
using mse_f_ffa_rm = matrix_storage_engine<float, extents<size_t, 4, 4>, std::allocator<float>, matrix_layout::row_major>;
using mse_i_ffa_cm = matrix_storage_engine<int,   extents<size_t, 4, 4>, std::allocator<int>, matrix_layout::column_major>;
using mse_d_ffa_rm = matrix_storage_engine<double, extents<size_t, 4, 4>, std::allocator<double>, matrix_layout::row_major>;
...
TEST(MSE_Matrix_4B, CmpEq)
{
    ...
    EXPECT_FALSE(msupport::compare(e3, mse_f_ffa_rm(LST_44_1)));
}
...
TEST(MSE_Matrix_4B, EngineAssign)
{
    ...
    EXPECT_EQ(e4.row_capacity(), 4);
    EXPECT_EQ(e4.column_capacity(), 4);
    EXPECT_TRUE(msupport::compare(e4, il_44_2));
