...
//==================================================================================================
//
using mse_f_dd_cm = matrix_storage_engine<float, extents<dynamic_extent, dynamic_extent>, std::allocator<float>, column_major>;
using mse_f_dd_rm = matrix_storage_engine<float, extents<dynamic_extent, dynamic_extent>, std::allocator<float>, row_major>;
using mse_i_dd_cm = matrix_storage_engine<int, extents<dynamic_extent, dynamic_extent>, std::allocator<int>, column_major>;
using mse_d_dd_rm = matrix_storage_engine<double, extents<dynamic_extent, dynamic_extent>, std::allocator<double>, row_major>;
