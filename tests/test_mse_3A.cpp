...
//==================================================================================================
//
using mse_f_ffv_cm = matrix_storage_engine<float, extents<4, 1>, void, column_major>;
using mse_f_ffv_rm = matrix_storage_engine<float, extents<4, 1>, void, row_major>;
using mse_i_ffv_cm = matrix_storage_engine<int, extents<4, 1>, void, column_major>;
using mse_d_ffv_rm = matrix_storage_engine<double, extents<4, 1>, void, row_major>;
