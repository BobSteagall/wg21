...
TEST(AddTraits, Extraction)
{
    ...
    //
    static_assert(std::is_same_v<matrix_addition_element_traits_t<matrix_operation_traits, int, int>,
                                 matrix_operation_traits::addition_element_traits<matrix_operation_traits, int, int>>);

    static_assert(std::is_same_v<matrix_addition_engine_traits_t<matrix_operation_traits, eng_t, eng_t>,
                                 matrix_operation_traits::addition_engine_traits<matrix_operation_traits, eng_t, eng_t>>);

    static_assert(std::is_same_v<matrix_addition_arithmetic_traits_t<matrix_operation_traits, mat_t, mat_t>,
    ...
    //
    static_assert(std::is_same_v<matrix_addition_element_traits_t<test_add_op_traits_empty, int, int>,
                                 matrix_operation_traits::addition_element_traits<test_add_op_traits_empty, int, int>>);

    static_assert(std::is_same_v<matrix_addition_engine_traits_t<test_add_op_traits_empty, eng_t, eng_t>,
                                 matrix_operation_traits::addition_engine_traits<test_add_op_traits_empty, eng_t, eng_t>>);

    static_assert(std::is_same_v<matrix_addition_arithmetic_traits_t<test_add_op_traits_empty, int, int>,
    ...
    //
    static_assert(std::is_same_v<matrix_addition_element_traits_t<test_add_op_traits_nta, int, int>,
                                 test_element_add_traits_nta<test_add_op_traits_nta, int, int>>);

    static_assert(std::is_same_v<matrix_addition_engine_traits_t<test_add_op_traits_nta, eng_t, eng_t>,
                                 test_engine_add_traits_nta<test_add_op_traits_nta, eng_t, eng_t>>);

    static_assert(std::is_same_v<matrix_addition_arithmetic_traits_t<test_add_op_traits_nta, mat_t, mat_t>,
    ...
    //
    static_assert(std::is_same_v<matrix_addition_element_traits_t<test_add_op_traits_nct, int, int>,
                                 test_add_op_traits_nct::addition_element_traits<test_add_op_traits_nct, int, int>>);

    static_assert(std::is_same_v<matrix_addition_engine_traits_t<test_add_op_traits_nct, eng_t, eng_t>,
                                 test_add_op_traits_nct::addition_engine_traits<test_add_op_traits_nct, eng_t, eng_t>>);

    static_assert(std::is_same_v<matrix_addition_arithmetic_traits_t<test_add_op_traits_nct, mat_t, mat_t>,
                             ...
                             fs_matrix_engine_tst<T2, R2, C2>>
{
    ...
    using element_traits = matrix_addition_element_traits_t<OTR, T1, T2>;
                              ...
                              matrix<fs_matrix_engine_tst<double, 3, 4>, COT2>>
{
    ...
    using engine_traits = matrix_addition_engine_traits_t<op_traits, engine_type_1, engine_type_2>;
