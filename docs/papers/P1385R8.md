...
//
template<class OT1, class OT2>  struct matrix_custom_operation_traits_selector;

//- Arithmetic operators
//
template<class ET1, class COT1, class ET2, class COT2>  inline constexpr @(_see note_)@
operator +(matrix<ET1, COT1> const& m1, matrix<ET2, COT2> const& m2);
...
template<class S1, class ET2, class COT2>  inline constexpr @(_see note_)@
