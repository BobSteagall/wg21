...
The result is a matrix whose row count is that of column vector A, and whose
...
It is important that the default kernels supplied by the C++ standard adhere to 
