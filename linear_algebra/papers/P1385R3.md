...
geometry:
  ...
  - headheight=0.3in
  - footskip=0.4in
title: "Adding linear algebra support to the C++ standard library"
document: P1385R3
date: 2019-10-07
...
and access on behalf of an associated, owning *MathObj* instance.  At a 
...
functionality that it provides by creating a custom operation traits class in 
...
At the Cologne 2019 meeting, version R2 of this paper was reviewed by a 
combined session of SG14, SG19, and SG6.
