...
void t200()
{
    ...
    static_assert(STD_LA::detail::has_element_sub_traits_v<STD_LA::default_matrix_operation_traits, elem_t, elem_t>);
    ...
    static_assert(STD_LA::detail::has_engine_sub_traits_v<STD_LA::default_matrix_operation_traits, eng_t, eng_t>);
    ...
    static_assert(STD_LA::detail::has_sub_traits_v<STD_LA::default_matrix_operation_traits, opnd_t, opnd_t>);
