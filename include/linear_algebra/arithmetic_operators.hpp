...
template<class ET1, class OT1, class ET2, class OT2> inline constexpr
auto
operator +(basic_vector<ET1, OT1> const& v1, basic_vector<ET2, OT2> const& v2)
{
    using op_traits  = select_matrix_operation_traits_t<OT1, OT2>;
    using op1_type   = basic_vector<ET1, OT1>;
    using op2_type   = basic_vector<ET2, OT2>;
    using add_traits = detail::addition_arithmetic_traits_t<op_traits, op1_type, op2_type>;
...
template<class ET1, class OT1, class ET2, class OT2> inline constexpr
auto
operator +(basic_matrix<ET1, OT1> const& m1, basic_matrix<ET2, OT2> const& m2)
{
    using op_traits  = select_matrix_operation_traits_t<OT1, OT2>;
