...
operator -(basic_matrix<ET1, COT1> const& m1, basic_matrix<ET2, COT2> const& m2)
{
    ...
    using op1_type   = basic_matrix<ET1, COT1>;
    using op2_type   = basic_matrix<ET2, COT2>;
    using sub_traits = get_subtraction_arithmetic_traits_t<op_traits, op1_type, op2_type>;
...
auto
operator *(S1 const& s1, basic_matrix<ET2, COT2> const& m2)
{
...
operator /(basic_matrix<ET1, COT1> const& m1, S2 const& s2)
{
    ...
    using op1_type   = basic_matrix<ET1, COT1>;
    using op2_type   = S2;
    using div_traits = get_division_arithmetic_traits_t<op_traits, op1_type, op2_type>;
