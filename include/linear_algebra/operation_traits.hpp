...
namespace STD_LA {
//--------------------------------------------------------------------------------------------------
//  Class Template:     matrix_custom_operation_traits_selector
//
...
//--------------------------------------------------------------------------------------------------
//
template<class COT1, class COT2>    struct matrix_custom_operation_traits_selector;

template<>
struct matrix_custom_operation_traits_selector<void, void>
{
    using traits_type = void;
};

template<class COT2>
struct matrix_custom_operation_traits_selector<void, COT2>
{
    using traits_type = COT2;
};

template<class COT1>
struct matrix_custom_operation_traits_selector<COT1, void>
{
    using traits_type = COT1;
};

template<class COT1>
struct matrix_custom_operation_traits_selector<COT1, COT1>
{
    using traits_type = COT1;
};
...
using select_custom_matrix_operation_traits_t =
        typename matrix_custom_operation_traits_selector<COT1,COT2>::traits_type;
